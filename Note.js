class Note {
    constructor(value) {
        let notesColors = ['rgb(255, 255, 117)', 'rgb(184, 255, 162)', 'rgb(255, 152, 186)', 'rgb(137, 202, 255)']
        ...
        this.note.style.backgroundColor = notesColors[Math.floor((Math.random() * notesColors.length))];
